...
function GetSkillSvg(props) {
  ...
  else if (props.fileName === "LowLevelProgImg") return <LowLevelProgImg theme={props.theme} />;
  ...
  else if(props.fileName === "DatabaseImg") return <DatabaseImg theme={props.theme} />;
